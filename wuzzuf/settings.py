"""
Django settings for wuzzuf project.
...
WSGI_APPLICATION = "wuzzuf.wsgi.application"
...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Use App Passwords if using Gmail
